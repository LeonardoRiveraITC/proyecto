    ...
    >
      <v-list-item>
        <v-list-item-content>
          ...
          <p>Primer funcion: {{ actor.descripcion }}</p>
        </v-list-item-content>
      </v-list-item>
      <v-app>
        <v-card-actions>
          ...
          <v-dialog v-if="!dialog" max-width="600px" loading>
            ...
            <v-card>
              <v-card-title>
                <span class="text-h5">Editar Genero a partir de clave</span>
              </v-card-title>
              <v-card-text>
                <v-form>
                  <v-container>
...
export default {
  ...
  created() {
    ...
    axios.get("http://localhost:8000/admgenero.php").then((res) => {
